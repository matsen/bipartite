...
- **Is it the whole result, or the part that arrived first?** A partial result licenses no direction, and hedging it does not fix that. Measured 2026-09-02: the first band of a four-band experiment showed a lever helping where prior work said it hurt, and two sessions independently wrote a hedge — "one band, the interaction could easily differ" and "I'm not front-running the interpretation" — then stated the direction anyway. It reversed on the full table: the effect was substitution, not synergy, and the first band was the smallest and least decisive of the four. The hedge travelled less far than the direction did. Report the partial number if it is useful; do not attach a reading to it, because the reading is what gets quoted.
