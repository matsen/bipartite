...
![Bipartite system architecture](../images/architecture.svg)
...
| Spawn issue session | `bip spawn org/repo#123` | — |
...
### Discovering papers via ASTA

```
User: bip asta "phylogenetic methods for antibody repertoires"
         │
         ▼
┌─────────────────┐     ┌─────────────────┐
│    bip CLI      │────▶│   ASTA API      │
