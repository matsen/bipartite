---
name: pr-check
description: Quick PR readiness check — clean worktree, good description, squashed body. Run before /pr-review.
---

# /pr-check

Quick sanity check before running the heavier `/pr-review`. Catches common issues that waste review cycles.
...
- Run `/pr-review` after this passes for the full quality sweep
